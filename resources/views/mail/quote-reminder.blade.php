...
<head>
    ...
    <title>Rappel devis #{{ $purchaseId }}</title>
</head>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <h2 style="margin:0 0 20px;color:{{ $accentColor }};font-size:22px;font-weight:700;">
                                Rappel — Votre devis est en attente
                            </h2>
                            ...
                            <p style="margin:0 0 24px;color:#374151;font-size:15px;line-height:1.6;">
                                Nous vous rappelons que votre <strong>devis n° {{ $purchaseId }}</strong> d'un montant de <strong>{{ $quoteTotal }} {{ $currency }}</strong> est toujours en attente de votre réponse.
                            </p>
                            @endif
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-bottom:24px;">
                                <tr>
                                    <td style="background-color:#fef2f2;border-left:4px solid #dc2626;padding:12px 16px;border-radius:0 6px 6px 0;">
                                        <p style="margin:0;color:#991b1b;font-size:13px;">
                                            Ce devis expire le <strong>{{ $expiresAt }}</strong>. Passé ce délai, il sera automatiquement annulé et vous devrez effectuer une nouvelle demande.
                                        </p>
                                    </td>
                                </tr>
                            </table>
